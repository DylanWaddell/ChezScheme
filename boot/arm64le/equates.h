...
#define machine_type_tarm64le 0x22
...
#define max_float_alignment 0x10
#define max_integer_alignment 0x10
...
#define tc_U_disp 0x1A0
#define tc_V_disp 0x1A8
#define tc_W_disp 0x1B0
#define tc_X_disp 0x1B8
#define tc_Y_disp 0x1C0
#define tc_ac0_disp 0x68
#define tc_ac1_disp 0x70
#define tc_active_disp 0x174
#define tc_alloc_counter_disp 0x2D8
#define tc_ap_disp 0x90
#define tc_arg_regs_disp 0x0
#define tc_block_counter_disp 0x218
#define tc_cchain_disp 0x160
#define tc_code_ranges_to_flush_disp 0x168
#define tc_compile_profile_disp 0x270
#define tc_compress_format_disp 0x2B8
#define tc_compress_level_disp 0x2C0
#define tc_cp_disp 0x80
#define tc_current_error_disp 0x210
#define tc_current_input_disp 0x200
#define tc_current_mso_disp 0x228
#define tc_current_output_disp 0x208
#define tc_default_record_equal_procedure_disp 0x2A8
#define tc_default_record_hash_procedure_disp 0x2B0
#define tc_disable_count_disp 0x1D8
#define tc_eap_disp 0x98
#define tc_esp_disp 0x88
...
#define tc_guardian_entries_disp 0x158
#define tc_instr_counter_disp 0x2D0
#define tc_keyboard_interrupt_pending_disp 0x1F0
#define tc_lz4_out_buffer_disp 0x2C8
#define tc_meta_level_disp 0x268
#define tc_null_immutable_bytevector_disp 0x258
#define tc_null_immutable_fxvector_disp 0x250
#define tc_null_immutable_string_disp 0x260
#define tc_null_immutable_vector_disp 0x248
#define tc_optimize_level_disp 0x290
#define tc_parameters_disp 0x2E0
#define tc_random_seed_disp 0x170
#define tc_real_eap_disp 0xD0
#define tc_ret_disp 0xA0
#define tc_scheme_stack_disp 0x178
#define tc_scheme_stack_size_disp 0x190
#define tc_sfd_disp 0x220
#define tc_sfp_disp 0x78
#define tc_signal_interrupt_pending_disp 0x1E0
#define tc_signal_interrupt_queue_disp 0x1E8
#define tc_something_pending_disp 0x1C8
#define tc_stack_cache_disp 0x180
#define tc_stack_link_disp 0x188
#define tc_subset_mode_disp 0x298
#define tc_suppress_primitive_inlining_disp 0x2A0
#define tc_target_machine_disp 0x230
#define tc_td_disp 0xC8
#define tc_threadno_disp 0x1F8
#define tc_timer_ticks_disp 0x1D0
#define tc_trap_disp 0xA8
#define tc_ts_disp 0xC0
#define tc_virtual_registers_disp 0xD8
#define tc_winders_disp 0x198
#define tc_xp_disp 0xB0
#define tc_yp_disp 0xB8
...
/* machine types */
#define machine_type_names {"any", "i3le", "ti3le", "i3nt", "ti3nt", "i3fb", "ti3fb", "i3ob", "ti3ob", "i3osx", "ti3osx", "a6le", "ta6le", "a6osx", "ta6osx", "a6ob", "ta6ob", "a6s2", "ta6s2", "i3s2", "ti3s2", "a6fb", "ta6fb", "i3nb", "ti3nb", "a6nb", "ta6nb", "a6nt", "ta6nt", "i3qnx", "ti3qnx", "arm32le", "tarm32le", "arm64le", "tarm64le", "ppc32le", "tppc32le"}
...
/* thread-context data */
#define DSTBV(x) (*((ptr *)((uptr)(x)+744)))
#define SRCBV(x) (*((ptr *)((uptr)(x)+752)))
#define U(x) (*((ptr *)((uptr)(x)+416)))
#define V(x) (*((ptr *)((uptr)(x)+424)))
#define W(x) (*((ptr *)((uptr)(x)+432)))
#define X(x) (*((ptr *)((uptr)(x)+440)))
#define Y(x) (*((ptr *)((uptr)(x)+448)))
#define AC0(x) (*((void* *)((uptr)(x)+104)))
#define AC1(x) (*((void* *)((uptr)(x)+112)))
#define ACTIVE(x) (*((I32 *)((uptr)(x)+372)))
#define ALLOCCOUNTER(x) (*((U64 *)((uptr)(x)+728)))
#define AP(x) (*((void* *)((uptr)(x)+144)))
#define ARGREGS(x,i) (((void* *)((uptr)(x)+0))[i])
#define BLOCKCOUNTER(x) (*((ptr *)((uptr)(x)+536)))
#define CCHAIN(x) (*((ptr *)((uptr)(x)+352)))
#define CODERANGESTOFLUSH(x) (*((ptr *)((uptr)(x)+360)))
#define COMPILEPROFILE(x) (*((ptr *)((uptr)(x)+624)))
#define COMPRESSFORMAT(x) (*((ptr *)((uptr)(x)+696)))
#define COMPRESSLEVEL(x) (*((ptr *)((uptr)(x)+704)))
#define CP(x) (*((void* *)((uptr)(x)+128)))
#define CURRENTERROR(x) (*((ptr *)((uptr)(x)+528)))
#define CURRENTINPUT(x) (*((ptr *)((uptr)(x)+512)))
#define CURRENTMSO(x) (*((ptr *)((uptr)(x)+552)))
#define CURRENTOUTPUT(x) (*((ptr *)((uptr)(x)+520)))
#define DEFAULTRECORDEQUALPROCEDURE(x) (*((ptr *)((uptr)(x)+680)))
#define DEFAULTRECORDHASHPROCEDURE(x) (*((ptr *)((uptr)(x)+688)))
#define DISABLECOUNT(x) (*((ptr *)((uptr)(x)+472)))
#define EAP(x) (*((void* *)((uptr)(x)+152)))
#define ESP(x) (*((void* *)((uptr)(x)+136)))
#define FXFIRSTBITSETBV(x) (*((ptr *)((uptr)(x)+576)))
#define FXLENGTHBV(x) (*((ptr *)((uptr)(x)+568)))
#define GENERATEINSPECTORINFORMATION(x) (*((ptr *)((uptr)(x)+632)))
#define GENERATEPROCEDURESOURCEINFORMATION(x) (*((ptr *)((uptr)(x)+640)))
#define GENERATEPROFILEFORMS(x) (*((ptr *)((uptr)(x)+648)))
#define GUARDIANENTRIES(x) (*((ptr *)((uptr)(x)+344)))
#define INSTRCOUNTER(x) (*((U64 *)((uptr)(x)+720)))
#define KEYBOARDINTERRUPTPENDING(x) (*((ptr *)((uptr)(x)+496)))
#define LZ4OUTBUFFER(x) (*((void* *)((uptr)(x)+712)))
#define METALEVEL(x) (*((ptr *)((uptr)(x)+616)))
#define NULLIMMUTABLEBYTEVECTOR(x) (*((ptr *)((uptr)(x)+600)))
#define NULLIMMUTABLEFXVECTOR(x) (*((ptr *)((uptr)(x)+592)))
#define NULLIMMUTABLESTRING(x) (*((ptr *)((uptr)(x)+608)))
#define NULLIMMUTABLEVECTOR(x) (*((ptr *)((uptr)(x)+584)))
#define OPTIMIZELEVEL(x) (*((ptr *)((uptr)(x)+656)))
#define PARAMETERS(x) (*((ptr *)((uptr)(x)+736)))
#define RANDOMSEED(x) (*((U32 *)((uptr)(x)+368)))
#define REAL_EAP(x) (*((void* *)((uptr)(x)+208)))
#define RET(x) (*((void* *)((uptr)(x)+160)))
#define SCHEMESTACK(x) (*((void* *)((uptr)(x)+376)))
#define SCHEMESTACKSIZE(x) (*((iptr *)((uptr)(x)+400)))
#define SFD(x) (*((ptr *)((uptr)(x)+544)))
#define SFP(x) (*((void* *)((uptr)(x)+120)))
#define SIGNALINTERRUPTPENDING(x) (*((ptr *)((uptr)(x)+480)))
#define SIGNALINTERRUPTQUEUE(x) (*((ptr *)((uptr)(x)+488)))
#define SOMETHINGPENDING(x) (*((ptr *)((uptr)(x)+456)))
#define STACKCACHE(x) (*((ptr *)((uptr)(x)+384)))
#define STACKLINK(x) (*((ptr *)((uptr)(x)+392)))
#define SUBSETMODE(x) (*((ptr *)((uptr)(x)+664)))
#define SUPPRESSPRIMITIVEINLINING(x) (*((ptr *)((uptr)(x)+672)))
#define TARGETMACHINE(x) (*((ptr *)((uptr)(x)+560)))
#define TD(x) (*((void* *)((uptr)(x)+200)))
#define THREADNO(x) (*((ptr *)((uptr)(x)+504)))
#define TIMERTICKS(x) (*((ptr *)((uptr)(x)+464)))
#define TRAP(x) (*((void* *)((uptr)(x)+168)))
#define TS(x) (*((void* *)((uptr)(x)+192)))
#define VIRTUALREGISTERS(x,i) (((ptr *)((uptr)(x)+216))[i])
#define WINDERS(x) (*((ptr *)((uptr)(x)+408)))
#define XP(x) (*((void* *)((uptr)(x)+176)))
#define YP(x) (*((void* *)((uptr)(x)+184)))
#define ARGREG(x,i) (((void* *)((uptr)(x)+0))[i])
#define VIRTREG(x,i) (((ptr *)((uptr)(x)+216))[i])
